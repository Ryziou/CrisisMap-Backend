"""
Django settings for crisismap project.
...
SIMPLE_JWT = {
    ...
    'TOKEN_OBTAIN_SERIALIZER': 'users.serializers.token.CustomTokenSerializer',
}
...
WSGI_APPLICATION = 'crisismap.wsgi.application'
